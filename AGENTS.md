...
## Configuration Notes
The app targets macOS 14+ and Swift 6. Bundle identifiers and build settings live directly in `CompactBitmapPNG.xcodeproj/project.pbxproj`.
